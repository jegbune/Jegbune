    ...
    <div>
      <div className="flex flex-col md:flex-row py-12 md:p-16 px-8 gap-8">
        <div className="flex-1 p-12">
          <h1 className="font-Montserrat text-5xl md:text-7xl font-extrabold leading-normal bg-clip-text text-transparent bg-text-gradient">Welcome to My PortFolio</h1>
