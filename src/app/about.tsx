  ...
  return (
    <div id='about' className='flex flex-col gap-8 bg-white p-8 md:p-16'>
      ...
      <div className="flex flex-col gap-12 md:flex-row">    
        <div className="flex md:w-[40%] text-center flex-col justify-center border-t-2 border-gray-100  items-center text-2xl shadow-green-300 shadow-md rounded-xl p-10">
        {data}
          </div>
